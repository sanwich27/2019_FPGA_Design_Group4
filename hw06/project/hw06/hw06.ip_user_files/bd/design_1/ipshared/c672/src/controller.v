(* keep_hierarchy = "yes" *)module	controller(
	input clk,
	input rst_n,
	...
	input              cmd_valid,
	input 	[31:0]      result,//return the value after processed from memory
	output 	wire [31:0]		data_ps,
	output  wire [7:0]		address_ps,
	output  wire [31:0]     result_out, //show the result on ps//AXI
